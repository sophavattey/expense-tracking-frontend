...
/* ─── Sophea mock profile (real person placeholder) ─── */
const SOPHEA_AVATAR = "https://i.pravatar.cc/150?img=47";

/* ─── Phone Mockup ─── */
function PhoneMockup() {
  return (
    <div className="relative w-[260px] mx-auto select-none">
      <div className="rounded-[2.5rem] bg-gradient-to-b from-gray-800 to-gray-900 p-3 shadow-2xl shadow-gray-900/40 border border-gray-700">
          ...
          <div className="bg-blue-600 px-4 pt-3 pb-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <img src={SOPHEA_AVATAR} alt="Sophea"
          ...
          <div className="p-3 space-y-3">
            <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
              <div className="flex items-center justify-between mb-1">
                <p className="text-gray-400 text-[10px] font-semibold uppercase tracking-wider">Total Spent</p>
              ...
              <p className="text-gray-800 text-xl font-black">$34.25</p>
              <p className="text-gray-400 text-[10px]">៛137,000 · March 2026</p>
              ...
              <div className="flex justify-between mt-1">
                <span className="text-gray-400 text-[9px]">34% of $100 budget</span>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
              <div className="px-3 pt-2.5 pb-1 flex items-center justify-between">
                <p className="text-gray-700 text-[11px] font-bold">Recent</p>
                <ChevronRight size={12} strokeWidth={2.5} className="text-gray-300" />
              </div>
              {DEMO_TX.map((tx) => (
                <div key={tx.name} className="flex items-center gap-2.5 px-3 py-2 border-t border-gray-50">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-gray-800 text-[10px] font-semibold truncate">{tx.name}</p>
                    <p className="text-gray-400 text-[9px]">{tx.cat}</p>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="text-red-500 text-[10px] font-bold">{tx.amount}</p>
                    <p className="text-gray-400 text-[9px]">{tx.khr}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-3 mb-6">
            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
              ...
              <p className="text-gray-800 text-2xl font-black">$124</p>
              <p className="text-gray-400 text-xs mt-0.5">៛496,000</p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
              <div className="flex items-center gap-1.5 mb-1">
              ...
              <p className="text-gray-800 text-2xl font-black">$176</p>
              <p className="text-green-500 text-xs mt-0.5 font-semibold">59% budget left</p>
            </div>
          </div>

          <p className="text-gray-800 text-sm font-bold mb-3">Recent Transactions</p>
          {[
            ...
            <div key={tx.name} className="flex items-center justify-between py-2.5 border-b border-gray-50 last:border-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-[10px]">{tx.cat}</p>
                </div>
              </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-50">
            <div className="flex justify-between mb-2">
              <p className="text-gray-800 text-xs font-bold">Monthly Budget</p>
              <p className="text-gray-400 text-xs">$124 / $300</p>
            </div>
            <div className="w-full bg-gray-100 rounded-full h-2.5">
              <div className="bg-blue-600 h-2.5 rounded-full relative" style={{ width: "41%" }}>
            ...
            <div className="flex justify-between mt-1.5">
              <span className="text-gray-400 text-[10px]">41% used</span>
              <span className="text-green-500 text-[10px] font-semibold">$176 remaining</span>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-blue-100/50 rounded-full blur-3xl -z-10" />
    </div>
  );
}
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        {/* ── Hero ─── */}
        <section className="relative min-h-screen flex items-center pt-16 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-blue-50">
          <div className="absolute -top-32 -right-32 w-[500px] h-[500px] bg-blue-100 rounded-full blur-[100px] opacity-60" />
          <div className="absolute bottom-0 -left-48 w-[400px] h-[400px] bg-blue-50 rounded-full blur-[80px] opacity-80" />
          ...
          <div className="max-w-6xl mx-auto px-6 py-20 w-full relative">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h1 className="text-5xl lg:text-6xl font-black text-gray-800 leading-[1.05] mb-6" style={fadeIn(100)}>
                  Master Your
                  <span className="block text-blue-600 relative">
                    Finances
                    <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 240 12" fill="none">
                      <path d="M2 9 Q60 3 120 7 Q180 11 238 5" stroke="#93c5fd" strokeWidth="3" strokeLinecap="round" />
                    </svg>
                  </span>
                 
                </h1>

                <p className="text-gray-500 text-lg leading-relaxed mb-8 max-w-md" style={fadeIn(200)}>
                ...
                <div className="flex flex-wrap gap-4" style={fadeIn(300)}>
                  ...
                  <a href="#how-it-works"
                    className="bg-white hover:bg-gray-50 text-gray-700 font-bold px-7 py-3.5 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:-translate-y-0.5">
                    See How It Works
                  </a>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-8" style={fadeIn(400)}>
                  {[
                    ...
                    <span key={label} className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-gray-600 text-xs font-semibold px-3 py-1.5 rounded-full shadow-sm">
                      <Icon size={11} strokeWidth={2.5} className="text-blue-500" />
                      {label}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex justify-center lg:justify-end" style={fadeIn(400)}>
                <div className="relative float">
                  <PhoneMockup />
                  <div className="absolute -left-14 top-20 bg-white rounded-2xl px-3 py-2 shadow-lg border border-gray-100 float-slow" style={{ animationDelay: "1s" }}>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-gray-800 text-xs font-black">$124.50</p>
                      </div>
                    </div>
                  </div>
                  <div className="absolute -right-12 bottom-28 bg-white rounded-2xl px-3 py-2 shadow-lg border border-gray-100 float-slow" style={{ animationDelay: "2s" }}>
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 rounded-lg bg-indigo-50 flex items-center justify-center">
                        <Users size={14} strokeWidth={2} className="text-indigo-500" />
                      </div>
                      <div>
                        <p className="text-[10px] text-gray-400">Group Budget</p>
                        <p className="text-gray-800 text-xs font-black">3 members</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <DashboardPreview />
              <div>
                <span className="text-blue-600 text-xs font-bold uppercase tracking-widest">Dual Currency</span>
                <h2 className="text-4xl font-black text-gray-800 mt-3 mb-6 font-['Sora',sans-serif]">
                  Riel or Dollar?<br />
                ...
                <div className="space-y-4">
                  {[
                    { Icon: ArrowLeftRight, iconBg: "bg-blue-50",  iconColor: "text-blue-600",  title: "Dual Display",       desc: "Every amount shown in both KHR and USD simultaneously, everywhere in the app" },
                    { Icon: TrendingUp,     iconBg: "bg-green-50", iconColor: "text-green-600", title: "Preferred Currency", desc: "Set KHR or USD as your primary — dashboards, stats, and budgets all follow" },
                    { Icon: BarChart2,      iconBg: "bg-cyan-50",  iconColor: "text-cyan-600",  title: "Unified Reports",    desc: "Monthly reports that unify both currencies into clear totals you can actually read" },
                  ].map((item) => (
                    <div key={item.title} className="flex gap-4 items-start">
                      <div className={`w-10 h-10 rounded-xl ${item.iconBg} flex items-center justify-center shrink-0 border border-gray-100`}>
