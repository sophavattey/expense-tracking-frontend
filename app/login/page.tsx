...
function StatPill({ icon: Icon, label, value, color, style }: {
  ...
  return (
    <div className="absolute bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-4 py-3 shadow-xl" style={style}>
          ...
          <div className="w-full max-w-[420px]">
            ...
            {fromInvite && (
              <div className="form-in mb-6 flex items-center gap-3 bg-indigo-50 border border-indigo-200 rounded-2xl px-4 py-3.5">
                ...
                <div>
                  <p className="text-indigo-800 text-sm font-bold">You've been invited!</p>
                  <p className="text-indigo-500 text-xs mt-0.5">
                    Sign in to join the group
                    {inviteCode && <> with code <span className="font-bold tracking-widest">{inviteCode}</span></>}.
                  </p>
                </div>
              </div>
            )}
